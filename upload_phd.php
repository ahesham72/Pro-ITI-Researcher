...
<h2 class="awesome-head h1 head-border-center uppercase text-center"> Uploading Ph.d</h2>
<div class="formdiv">
<form method="POST" action="upload_phd.php" enctype="multipart/form-data" class="form_upload" >
	<!-- COMPONENT START -->
    <br>
    <label for="">Titel of Ph.D :</label>
    <input type="text" class="form-control" placeholder='Enter The Title...' name='title_phd' required/><br>
    ...
    <div><input type="text" class="form-control" placeholder='Enter your Supervisor Name...' name='supervisor_name' required/></div><br>
	<!-- <button class=" btnplus btn">+</button><br>	 -->
...
if(isset($_POST['register']))
{
	...
	$insert_user="INSERT INTO `phd`(`p_title`, `uni_name`, `faculty_name`, `p_preview`, `p_date`, `r_idFK`,`super_name`,`file`) VALUES (?,?,?,?,?,?,?,?)";
...
// $insert_super="INSERT INTO `supervisors`( `super_name`) VALUES (?,?,?)";
