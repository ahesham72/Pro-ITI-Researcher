...
<div class="container">
	...
	<div class="formdiv">
<form method="POST" action="insert_mas.php" enctype="multipart/form-data" class="form_upload">
	<!-- COMPONENT START -->
    <br>
...
if(isset($_POST['register']))
{
	...
	$insert_user="INSERT INTO `master`(`m_title`, `uni_name`, `faculty_name`, `m_preview`, `m_date`, `r_idFK`,`file`) VALUES (?,?,?,?,?,?,?)";
