...
<div class="formdiv">
<form method="POST" action="insert_researches.php" enctype="multipart/form-data" class="form_upload">
	<!-- COMPONENT START -->
    <br>
    <label for="">Titel of Research :</label>
    <input type="text" class="form-control" placeholder='Enter The Title......' name='title_research' /><br>
    <label for="">Abstract:</label>
    <textarea  id="" cols="30" rows="10" class="form-control"  name='preview'></textarea>
    ...
    <input type="text" class="form-control" placeholder='Enter The Magazine Name......' name='magazine' /><br>
